...
namespace REALLY9.Areas.Admin.Controllers
{
    ...
    public class AdminCustomersController : Controller
    {
        ...
        public AdminCustomersController(Really9Context context, IToastNotification toastNotification)
        {
            _context = context;
        ...
        public IActionResult Index(int? page)
        {
           ...
           // return _context.Customers != null ? 
                         ...
                         // Problem("Entity set 'Really9Context.Customers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Really9Context.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
